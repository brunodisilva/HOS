...
<body bgcolor="#FFFFFF" text="#000000">
 <form name="form1" method="post" action="add_member.php">
...
<td width="164" height="299" valign="top" bgcolor="#FFFFCC"><table width="164" border="0" cellspacing="0" cellpadding="3">
        ...
        <td width="577" valign="top"><table width="577" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="577" height="797" align="center" valign="top"><p align="center">&nbsp;</p>
              <p align="center"><span class="style21">Add New Member </span></p>
              <?
				  ...
				  $result=mysql_query("select uname,email from authuser");
					...
					elseif((strtolower($row[1])==strtolower($v_email))&&($v_username<>'')&&($v_email<>'')) {$err_email="This email address(<font color=red>$v_email</font>) already exists, please use different one.<br>"; $g=1; }
					}
				  ...
				  print "</td></tr></table>";
				    ...
				    $vw=0;
				    if($v_welcome=='Yes') {$vw=1;}  
					$enpass=base64_encode("$v_password");
					mysql_query("insert into authuser (uname,passwd,name,email,address,city,state,zip,country,phone,create_time,logincount,welcome,signup) values ('$v_username','$enpass','$v_name','$v_email','$v_address','$v_city','$v_state','$v_zip','$v_country','$v_phone',now(),'0','$vw','0')");
					$active=0;
					for($j=0;$j<$v_anum;$j++) {
					...
					$result=mysql_query("select subject,contents from emailtemplates where name='addmember'");
					while($row = mysql_fetch_array($result, MYSQL_NUM)) {
...
&nbsp;        <div align="center">
  ...
  <option <? if($v_country=='Zimbabwe'){echo 'selected';} ?>>Zimbabwe</option>
            ...
            <tr>
    <td width="131"><span class="style23"><font size="2" face="Arial">Phone</font></span></td>
    <td width="241"><font face="Arial" size="2"><input name="phone" size="30"  value="<? echo "$v_phone"; ?>"  style="border: 1px solid #808080; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1; background-color: #ECEAE6" ></font></td>
            </tr>
            <tr>
    <td width="131"></td>
    <td width="241"></td>
            ...
            <tr>
    <td colspan="2">
      <p align="left" class="style22"><font face="Arial" size="2">Select protected directory(access name) for this member: </font></td>
            </tr>
  <center>
          <center>
		  <?
		...
		$s='';
		if(strtolower($v_accessck[$k])=='on') {$s='checked';}
    ...
    <td width="241"></td>
            ...
            <tr>
    <td colspan="2">
      <p align="left" class="style22"><font face="Arial" size="2">Notify user  of account creation: 
          &nbsp;&nbsp;&nbsp;
    ...
    <td colspan="2" align="center">
      <p align="left"><span class="style22"><font face="Arial" size="2">Set welcome page :&nbsp;&nbsp;&nbsp;
            <font face="Arial" size="2">
            <select size="1" name="welcome" style="border: 1px solid #808080; padding-left: 0; padding-right: 0; padding-top: 1; padding-bottom: 1; background-color: #ECEAE6">
              <option <? if($v_welcome=='Yes') {echo 'selected'; }?>>Yes</option>
              <option <? if($v_welcome=='No') {echo 'selected'; }?>>No</option>
            </select>
            </font> </font></span>	  </td>
            </tr>
            <tr>
    ...
    <td colspan="2" align="center">
      ...
      * </font>Required
      field<font  face="vernada" size="2"  color="#000080"><br>
      </font></font></p>
    </td>
            </tr>
          </table>
  ...
  <input type="hidden" name="action" value="addnew_account">              
              <blockquote>
                <p align="left">&nbsp;</p>
              </blockquote>              </td>
          </tr>
